...
By default, this script will log summaries to ./retrained/retrain_logs directory

Visualize the summaries with this command:

tensorboard --logdir ./retrained/retrain_logs
...
python retrain.py (... other args as before ...) \
    --saved_model_dir=./retrained/saved_models/$(date +%s)/
tensorflow_model_server --port=9000 --model_name=my_image_classifier \
    --model_base_path=./retrained/saved_models/
```
"""
...
CHECKPOINT_NAME = './retrained/_retrain_checkpoint'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='./retrained/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='./retrained/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='./retrained/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='./retrained/retrain_logs',
